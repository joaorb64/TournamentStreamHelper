...
def generate_youtube(scoreboard_id=1, use_phase_name=True, use_characters=True, ignore_characters=[]):
...
"""
    ...
    for character in ignore_characters:
        title_long = title_long.replace(character, "")
        title_short = title_short.replace(character, "")
