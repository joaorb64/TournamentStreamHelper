    ...
    if (!oldData.score ||
      ...
      Object.values(data.score.last_sets["2"]).slice(0, 3).forEach((sets, s) => {
        ...
        Object.values(data.score.last_sets["2"]).slice(0, 3).forEach((sets, s) => {
          ...
          SetInnerHtml($(`.player2_content .set${s+1} .phase`), phaseTexts.join(" "));
          SetInnerHtml($(`.player2_content .set${s+1} .match`), sets.round_name);
          SetInnerHtml($(`.player2_content .set${s+1} .winner .name`), 
          `
            <span class="sponsor">
          ...
          SetInnerHtml($(`.player2_content .set${s+1} .winner .score`), sets.winner_score);
          SetInnerHtml($(`.player2_content .set${s+1} .loser .name`), 
          `
            <span class="sponsor">
          ...
          SetInnerHtml($(`.player2_content .set${s+1} .loser .score`), sets.loser_score);
