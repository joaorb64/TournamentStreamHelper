LoadEverything().then(() => {
    ...
    async function team_html(set, t, s, isTeams, resolver){
        ...
        let flag_small = config.display.state_flag && config.display.country_flag ? "flag_small" : ""
        ...
        return `
            <div class = "p${t} team">
                ...
                <div class = "flags">
                    ${ isTeams ? "" : 
                        (player.country.asset && config.display.country_flag ? `<div class='flag ${flag_small}' style='background-image: url(../../${player.country.asset.toLowerCase()})'></div>` : "") + 
                        (player.state.asset  && config.display.state_flag ? `<div class='flag ${flag_small}' style='background-image: url(../../${player.state.asset.toLowerCase()})'></div>` : "")
                    }
                </div>
                <div class = "name">
                    <div class = "tag"></div>
            ...
            html += `
                <div class="set${current_set_nb} set">
                    ...
                    <div class = "vs_container">
                        ${!config.display.match ? `<div class = "vs">VS</div>` : ""}
                        ${config.display.match ? `<div class = "match"> </div>` : ""}
